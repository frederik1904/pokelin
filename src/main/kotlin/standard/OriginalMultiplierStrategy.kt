...
class OriginalMultiplierStrategy : MultiplierStrategy {
    private val effectivenessMap = mapOf(
        Pair(NORMAL, ROCK) to Weak, Pair(NORMAL, GHOST) to Inefective, Pair(NORMAL, STEEL) to Weak,

        Pair(FIGHTING, NORMAL) to Strong, Pair(FIGHTING, FLYING) to Weak, Pair(FIGHTING, POISON) to Weak,
        Pair(FIGHTING, ROCK) to Strong, Pair(FIGHTING, BUG) to Weak, Pair(FIGHTING, GHOST) to Inefective,
        ...
        Pair(POISON, GHOST) to Weak, Pair(POISON, STEEL) to Inefective, Pair(POISON, GRASS) to Strong,
        Pair(POISON, FAIRY) to Strong,

        Pair(GROUND, FLYING) to Inefective, Pair(GROUND, POISON) to Strong, Pair(GROUND, ROCK) to Strong,
        ...
        Pair(GHOST, NORMAL) to Inefective, Pair(GHOST, GHOST) to Strong, Pair(GHOST, PSYCHIC) to Strong,
        ...
        Pair(ELECTRIC, FLYING) to Strong, Pair(ELECTRIC, ROCK) to Inefective, Pair(ELECTRIC, FIRE) to Strong,
        ...
        Pair(PSYCHIC, PSYCHIC) to Weak, Pair(PSYCHIC, DARK) to Inefective,
        ...
        Pair(DRAGON, STEEL) to Weak, Pair(DRAGON, DRAGON) to Strong, Pair(DRAGON, FAIRY) to Inefective,
